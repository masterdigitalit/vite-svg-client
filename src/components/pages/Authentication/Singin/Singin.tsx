				...
				<div className={style.main}>
					<div className={style.form}>
						...
						<div className={style["continue-with"]}>
							...
							<div className={style["sing-in-container"]}>
								<div className="">
									<img src={"/static/svg/icons/google.svg"} alt="" /> <div className={style.title}>google</div>{" "}
								</div>
								<div className="">
									<img src={"/static/svg/icons/yandex.svg"} alt="" /> <div className={style.title}>yandex</div>{" "}
								</div>
							</div>
						</div>
					</div>
					<div className={style.icon}>
						<img src={"/static/svg/pages/sing-in.svg"} alt="" />
					</div>
				</div>
			</div>
		</>
