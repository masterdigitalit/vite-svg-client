	...
	return (
		<>
			...
			<div className={style["style-collections"]}>
				...
				<div className={style["info-title"]}>A list of vector collections by their style categorization. Browse 30+ different SVG icons and vector styles by color type and join shape.</div>
						...
						<Link to={`/collection/${el.title}`} key={el.title}>
							<div className={style.item}>
								<div className={style.images}>
									<img src={`/static/svg/${el.svg}`} width={'auto'} alt="" />
								</div>
								{el.title}
							</div>
						</Link>
